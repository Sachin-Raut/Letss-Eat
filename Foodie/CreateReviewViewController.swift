...
class CreateReviewViewController: UITableViewController
{
    ...
    {
        guard let navController = segue.destination as? UINavigationController, let viewController = navController.topViewController as? ApplyFilterViewController
        else
        {
            return
        }
    ...
    {
        guard let navController = segue.destination as? UINavigationController, let viewController = navController.topViewController as? StarratingViewController
        else
        {
            return
        }
    ...
    @IBAction func unwindFilterSave(segue: UIStoryboardSegue)
    {
        ...
        {
            if let thumbnail = viewController.imagExample.image
            {
    ...
    @IBAction func onSaveTapped(_ sender: AnyObject)
    {
        ...
        //send user back to restaurant details
